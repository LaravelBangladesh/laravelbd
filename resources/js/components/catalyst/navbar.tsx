...
export const NavbarItem = forwardRef(function NavbarItem(
    ...
    let classes = clsx(
        // Base
        'relative flex min-w-0 items-center gap-3 rounded-none p-2 text-left text-base/6 font-medium text-zinc-950 sm:text-sm/5',
        ...
        <span className={clsx(className, 'relative')}>
            {current && (
                <motion.span
                    ...
                    className="bg-brand-green absolute inset-x-2 -bottom-2.5 h-0.5 rounded-none"
                />
            )}
