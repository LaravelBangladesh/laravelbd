...
export const SidebarItem = forwardRef(function SidebarItem(
    ...
    let classes = clsx(
        // Base
        'flex w-full items-center gap-3 rounded-none px-2 py-2.5 text-left text-base/6 font-medium text-zinc-950 sm:py-2 sm:text-sm/5',
        ...
        <span className={clsx(className, 'relative')}>
            {current && (
                <motion.span
                    ...
                    className="absolute inset-y-2 -left-4 w-0.5 rounded-none bg-zinc-950"
                />
            )}
