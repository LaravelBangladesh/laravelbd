        ...
        >
            <div className="flow-root max-w-full">
                <div
                    ...
                    className={clsx(
                        className,
                        '-mx-(--gutter) max-w-full overflow-x-auto whitespace-nowrap',
                    )}
                >
                    <div
                        className={clsx(
        ...
        >
            <tr
                ...
                className={clsx(
                    className,
                    href &&
                        'has-[[data-row-link][data-focus]]:outline-brand-green has-[[data-row-link][data-focus]]:outline-2 has-[[data-row-link][data-focus]]:-outline-offset-2',
