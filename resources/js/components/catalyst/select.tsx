    ...
    return (
        <span
            ...
            className={clsx([
                ...
                // Focus ring
                'has-data-focus:after:ring-brand-green after:pointer-events-none after:absolute after:inset-0 after:rounded-none after:ring-transparent after:ring-inset has-data-focus:after:ring-2',
                // Disabled state
